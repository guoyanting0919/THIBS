    ...
    <div class="app-container flex-item">
      ...
      <div class="formContainer bg-white customScrollBar">
          ...
          <el-row :gutter="16">
            <el-col :sm="12" :md="8">
              <el-form-item label="路線名稱" prop="name">
                <el-input placeholder="請輸入路線名稱" v-model="temp.name"></el-input>
              </el-form-item>
            </el-col>
            <el-col :sm="12" :md="8">
              <el-form-item label="路線名稱(英文)">
                <el-input placeholder="請輸入路線名稱(英文)" v-model="temp.lineCode"></el-input>
              </el-form-item>
            </el-col>
            <el-col :sm="12" :md="8">
              <el-form-item label="排序">
                <el-input-number style="width: 100%" v-model="temp.sort" :min="0" :max="999"></el-input-number>
              </el-form-item>
            </el-col>
            <el-col :sm="12" :md="24">
              <el-form-item label="行駛日">
                <el-checkbox-group v-model="checkedWeek">
                  <el-checkbox v-for="day in dayList" :label="day.value" :key="day.value">{{ day.label }}</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
            </el-col>
          </el-row>
        ...
        <div class="sortContainer">
          <el-transfer style="width: 100%" :target-order="'push'" filter-placeholder="請輸入站牌名" filterable v-model="checkesStops" :data="list" @change="handleChange" :titles="['可用站牌', '已使用站牌']" :button-texts="['刪除', '新增']"></el-transfer>
        </div>
        <div style="margin-top: 2rem">
          <SubTitle title="站點排序設定"></SubTitle>
          <draggable :list="sortData" v-if="sortData" class="draggableContainer" group="stop" :options="{
              animation: 300,
              group: 'people',
              scroll: true,
              scrollSpeed: 2000,
            ...
            <transition-group>
              <div v-for="(stop, index) in sortData" :key="stop.key" class="graggableItem" :index="index">
